...
```sh
  mkdir folder_name
  cd folder_name
  git clone https://github.com/lilskyex0x/Blog-app.git
```
...
Feel free to check the [issues page](https://github.com/lilskyex0x/Blog-app/issues).
...
If you like this project please give a star on [github](https://github.com/lilskyex0x) and also connect on [Linkedin](www.linkedin.com/in/aung-pyae-khant-932342251).
...
This project is [MIT](https://github.com/lilskyex0x/Blog-app/blob/39691d893432c719a694bf4793b69483441d72d2/LICENSE) licensed.
